 ...
 */
    get(selector) {
        ...
        if (element == null || element == undefined) {
            throw new Error(`Cannot find an element with the identifier ${selector}. Perhaps it has not loaded in or does not exist.`);
        }
        return element;
    },
    /**
    ...
    matchingObj(array, propertyAndDesiredValue) {
        ...
        if (desired == null) {throw new Error("No such object found.")};
        return desired;
    }
